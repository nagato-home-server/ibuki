...
GRE_CHILD=gre-namespace-v2 GRE_OUTER_LOCAL_ENDPOINT=198.18.1.1 GRE_OUTER_REMOTE_ENDPOINT=198.18.2.1 OUT_DIR="$OUT_DIR" RUN_BASE="$RUN_BASE" sh scripts/vm-netns-ipsec-gre-start.sh
